 ...
 *
 *  This file Copyright (C) 2010,2012,2014-2017,2019-2022 Jeremy D Monin <jdmonin@nand.net>
 *
...
public class Main
{
	 ...
	 * @since 0.9.07
	 */
	public static final int APP_VERSION_CODE = 993;
	 ...
	 * @since 0.9.07
	 */
	public static final String APP_VERSION_STRING = "0.9.93";
