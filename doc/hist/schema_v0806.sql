...
-- version 0.8.06 schema for SQLite 3.4 or higher  2010-10-15
...
insert into appinfo (aifield, aivalue) values ('DB_CREATE_SCHEMAVERSION', '0806');
insert into appinfo (aifield, aivalue) values ('DB_CURRENT_SCHEMAVERSION', '0806');
