...
-- version 0.8.07 schema for SQLite 3.4 or higher  2010-10-15
...
create table appinfo ( _id integer PRIMARY KEY AUTOINCREMENT not null, aifield varchar(32) not null unique, aivalue varchar(64) not null );
	...
	-- DB_CURRENT_SCHEMAVERSION (0807 unless upgraded)
	-- DB_UPGRADED_DATETIME (may not be present)
	-- DB_UPGRADED_APPNAME (may not be present)

insert into appinfo (aifield, aivalue) values ('DB_CREATE_SCHEMAVERSION', '0807');
insert into appinfo (aifield, aivalue) values ('DB_CURRENT_SCHEMAVERSION', '0807');
